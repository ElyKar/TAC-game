...
public class Pascal extends AgentImpl {
  ...
  private float bestValue=250;//valeur a laquelle on ach�te directement un vol.
  ...
  //delta est le delta utilis� pour les hotels, il correspond 
  ...
  public void quoteUpdated(Quote quote) {
	...
	//si notre prix est sup�rieur au prix demand� + le delta on le met a jour
	//sinon on le laisse tel quel
    	...
    	if(alloc>0)
    	{
    		...
    		//si on trouve un prix en dessus du prix initial + 20% on l'ach�te
    		...
    		//si il reste moins d'une minute on ach�te tout
